  ...
  <div>
    ...
    >
      <template #headline>
        ...
        >
          <NuxtLink
            :to="`https://github.com/nuxt/ui/releases/tag/v${config.version
              .split('.')
              .slice(0, -1)
              .join('.')}.0`"
            target="_blank"
          ...
          <span class="flex items-center gap-1">
            Nuxt UI v{{ config.version.split(".").slice(0, -1).join(".") }} is
            out!
          </span>
        </UBadge>
      </template>
    ...
    >
      ...
      >
        ...
        <template #links>
          <ClientOnly>
            <UAvatarGroup
              :max="xlAndLarger ? 13 : lgAndLarger ? 10 : mdAndLarger ? 16 : 8"
              size="md"
        ...
        >
          <NuxtLink
            ...
            to="https://npmjs.org/package/@nuxt/ui"
            target="_blank"
          >
            <p
    ...
    <template v-if="navigation.find((item) => item._path === '/pro')">
      <div class="relative">
        ...
        <div
          class="w-full relative overflow-hidden h-px bg-gradient-to-r from-gray-800 via-primary-400 to-gray-800 max-w-5xl mx-auto"
        />
      </div>

      <ULandingHero
        id="pro"
        :links="page.pro.links"
        :ui="{ title: 'sm:text-6xl' }"
      ...
      <div
        ref="sectionRef"
        :style="{ '--y': `${y}px`, '--inc': `${inc}px` }"
        class="_screen_xl"
      >
        <ULandingSection
          class="sticky h-screen top-0 flex !pb-16"
          :ui="{ container: 'flex-1 sm:gap-y-12' }"
        >
          <template #title>
            <Transition name="fade" mode="out-in">
              <span
                v-if="isAfterStep(steps.docs)"
                v-html="page.pro.docs?.title"
              />
          ...
          <template #description>
            <Transition name="fade" mode="out-in">
              <span
                v-if="isAfterStep(steps.docs)"
                v-html="page.pro.docs?.description"
              />
          ...
          <HomeProDemo ref="demoRef" :blocks="(blocks as HomeProBlock[])">
            ...
            <template #page-body>
              <div
                class="-mt-8 prose prose-primary prose-sm dark:prose-invert max-w-none"
              >
            ...
            <template #content-surround>
              <UContentSurround
                ...
                :ui="{
                  link: {
                    wrapper:
                      'px-4 py-2.5 border-gray-800/10 dark:border-gray-200/10 cursor-pointer',
                    icon: {
                      wrapper: 'mb-2 p-1',
                      base: 'h-4 w-4',
                    },
            ...
            <template #content-toc>
              <div class="absolute top-0 left-0 right-0 space-y-3">
                <UContentToc
                  :links="toc"
                  class="bg-transparent relative max-h-full overflow-hidden top-0"
                  :ui="({ container: { base: '!pt-0 !pb-4' } } as any)"
                />
                ...
                <UDivider
                  ...
                  :ui="{
                    border: {
                      base: 'border-gray-800/10 dark:border-gray-200/10',
                    },
                  }"
                />
            ...
            <template #landing-hero>
              <ULandingHero
                class="!p-0"
                :ui="{ title: '!text-5xl', description: 'text-base' }"
              >
                <template #title>
                  A <span class="text-primary">UI Library</span> for<br />
                  Modern Web Apps
                </template>
                ...
                <template #description>
                  ...
                  comprehensive collection of fully styled and customizable UI
                  components designed for Nuxt.
                </template>
            ...
            <template #landing-section>
              <ULandingSection
                :ui="{ title: '!text-3xl', description: 'text-base' }"
                class="!p-0"
              >
                <template #title>
                  Everything you expect from a<br />
                  <span class="text-primary">UI component library</span>
                </template>
              </ULandingSection>
            </template>
            ...
            <template #landing-cta>
              <ULandingCTA
                card
                :links="[
                  { label: 'Get started', color: 'black', size: 'md' },
                  {
                    label: 'Learn more',
                    color: 'black',
                    variant: 'link',
              ...
              >
                <template #title>
                  Trusted and supported by our<br />
                  amazing community
                </template>
              </ULandingCTA>
            </template>
      ...
      <div class="_not_screen_xl">
        <ULandingSection>
          ...
          <video
            preload="none"
            poster="https://res.cloudinary.com/nuxt/video/upload/so_14.4/v1698923423/ui-pro/nuxt-ui-pro-landing-demo_yrh6nr.jpg"
            controls
          >
            <source
              src="https://res.cloudinary.com/nuxt/video/upload/v1698923423/ui-pro/nuxt-ui-pro-landing-demo_yrh6nr.webm"
              type="video/webm"
            />
            <source
              src="https://res.cloudinary.com/nuxt/video/upload/v1698923423/ui-pro/nuxt-ui-pro-landing-demo_yrh6nr.mp4"
              type="video/mp4"
            />
            <source
              src="https://res.cloudinary.com/nuxt/video/upload/v1698923423/ui-pro/nuxt-ui-pro-landing-demo_yrh6nr.ogg"
              type="video/ogg"
            />
          </video>
        </ULandingSection>
        <ULandingSection>
          ...
          <video
            preload="none"
            poster="https://res.cloudinary.com/nuxt/video/upload/v1698923398/ui-pro/nuxt-ui-pro-docs-demo_jm6ubr.jpg"
            controls
          >
            <source
              src="https://res.cloudinary.com/nuxt/video/upload/v1698923398/ui-pro/nuxt-ui-pro-docs-demo_jm6ubr.webm"
              type="video/webm"
            />
            <source
              src="https://res.cloudinary.com/nuxt/video/upload/v1698923398/ui-pro/nuxt-ui-pro-docs-demo_jm6ubr.mp4"
              type="video/mp4"
            />
            <source
              src="https://res.cloudinary.com/nuxt/video/upload/v1698923398/ui-pro/nuxt-ui-pro-docs-demo_jm6ubr.ogg"
              type="video/ogg"
            />
          </video>
        </ULandingSection>
...
const landingBlocks = computed(() =>
  isAfterStep(steps.landing) && isBeforeStep(steps.docs)
    ? [
        {
          ...
          children: [
            {
              ...
              class: [
                ...
                isAfterStep(steps.landing + 2) &&
                  "-top-[calc(var(--y)-var(--step-y)-1rem)] bottom-[calc(var(--y)-var(--step-y)+1rem)]",
              ]
                .filter(Boolean)
                .join(" "),
              style: {
            ...
            isAfterStep(steps.landing + 2) && {
              ...
              class: [
                "inset-4",
                isBeforeStep(steps.landing + 6) &&
                  "-top-[calc(var(--y)-var(--prev-step-y)-var(--height)-1rem)] bottom-[calc(var(--y)-var(--prev-step-y)-var(--height)+1rem)]",
              ...
              children: [
                ...
                isAfterStep(steps.docs + 5)
                  ? {
                      ...
                      class: [
                        "inset-x-4 top-[4.25rem] bottom-4",
                        isAfterStep(steps.docs + 6) &&
                ...
                ...(isAfterStep(steps.docs + 9)
                  ? [
                      ...
                      },
                      {
                        ...
                        class:
                          "top-40 left-4 right-72 bottom-4 overflow-y-auto",
